...
# This repo is a portable leaf library: no host_examples/ app and no ESP-IDF
# example projects, so only src/include are checked. They stay in CHECK_BOTH so
# any future #ifdef ESP_PLATFORM branch is covered by the ESP pass automatically.
